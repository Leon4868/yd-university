...
export function LoginPage() {
  ...
  return (
    <div className="login-page page-container">
      ...
      <div className="login-card"><span className="brand-mark large"><ShieldCheck /></span><h2>欢迎来到 YD University</h2><p>{auth.demoMode ? "当前未配置 Privy App ID，将进入本地演示身份（默认学生角色）。" : "使用 Privy 安全登录，支持邮箱 / Google / GitHub / 钱包。"}</p><button className="button primary full" onClick={handleLogin}>使用邮箱 / Google / GitHub / 钱包继续</button><small>继续即表示你了解 Sepolia 测试代币没有真实价值。</small></div>
    </div>
  );
}
